...
export default function DoctorCreateScreen(props) {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    if (genero === "hombre") {
      setFotoUrl("https://res.cloudinary.com/plazasky/image/upload/v1662409177/doctores/male-doctor.png");
    }
    if (genero === "mujer") {
      setFotoUrl("https://res.cloudinary.com/plazasky/image/upload/v1662409177/doctores/female-doctor.png");
    }
